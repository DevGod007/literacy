...
Reply in this language:${language}`
	...
	return (
		<main className="flex justify-center min-h-screen back-gabin">
			{/* <Header /> */}
			<div className="fixed flex flex-col items-center sm:top-[30px] md:top-[80px] md:w-96 sm:w-80">
				<div className='flex flex-col justify-center items-center man-gabin'>
					<Image src={'/img/hat.png'} alt='hat' width={150} height={120} className='hat z-20 pl-2 w-[112px] h-[90px] md:w-[150px] md:h-[120px]' />
					<Image src={'/img/man-gabin.png'} alt='man' width={400} height={400} className='sm: w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] mt-[-55px] md:mt-[-70px]' />
					<span className={`font-alkatra mt-[-30px] text-white font-semibold text-5xl sm:text-5xl md:text-6xl z-10`}>Smart Gabin</span>
				</div>
			...
			{/* ------------- Modal ------------ */}
			<SummaryModal page='gabin' visible={isOpen} setVisible={setIsOpen} title={`Summary: ${subject}`} content={content} />
		</main>
	)
}
